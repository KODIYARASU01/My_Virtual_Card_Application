  ...
  return (
    <>
      <div className="home_container">
        ...
        <div className="slide_1_page" ref={HomeRef}>
              ...
              <div className="right">
                <div className="nav_list">
                  <ul>
                    ...
                    <li >
                      <NavLink  onClick={()=>scrollToSection(TemplateRef)}> Templates</NavLink>
                    </li>
                    <li>
                      <NavLink onClick={()=>scrollToSection(FeatureRef)}>Feature </NavLink>
                    </li>
                    <li>
                      <NavLink onClick={()=>scrollToSection(NFCRef)}>NFC</NavLink>
                    </li>
                    <li>
                      <NavLink onClick={()=>scrollToSection(PricingRef)}>Pricing </NavLink>
                    </li>
                    <li>
                      <NavLink onClick={()=>scrollToSection(FAQRef)}>FAQs </NavLink>
                    </li>
                    <li>
        ...
        <div className="slide_2_page" ref={TemplateRef} >
          <div className="title">
        ...
        <div className="slide_3_page" ref={FeatureRef}>
        ...
        <div className="slide_5_page" ref={NFCRef }>
        ...
        {/* Questions */}
        <div className="slide_7_page" ref={FAQRef}>
        ...
        {/* get_intouch */}
        <div className="slide_8_page" ref={ContactRef}>
